  ...
  <section class="py-24 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 px-4 md:px-0">
        <!-- Open Source -->
        <div class="group relative bg-white/50 dark:bg-gray-900/30 backdrop-blur-sm border border-gray-200 dark:border-gray-700/50 rounded-2xl p-6 md:p-8 text-center hover:border-gray-300 dark:hover:border-gray-600/50 transition-all duration-300 flex flex-col h-full">
          <div class="relative z-10 flex flex-col h-full">
            ...
            <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors">
              Open Source
            </h3>
            
            <p class="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed flex-1">
            ...
            <a
              ...
              class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-xl text-sm font-medium text-blue-600 dark:text-blue-300 hover:bg-blue-500/30 hover:border-blue-500/50 transition-all duration-300 group/btn"
            >
        ...
        <div class="group relative bg-white/50 dark:bg-gray-900/30 backdrop-blur-sm border border-gray-200 dark:border-gray-700/50 rounded-2xl p-6 md:p-8 text-center hover:border-gray-300 dark:hover:border-gray-600/50 transition-all duration-300 flex flex-col h-full">
          <div class="relative z-10 flex flex-col h-full">
            ...
            <NuxtLink
              ...
              class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-xl text-sm font-medium text-blue-600 dark:text-blue-300 hover:bg-blue-500/30 hover:border-blue-500/50 transition-all duration-300 group/btn"
            >
              <CheckCircleIcon class="mr-2 h-4 w-4 group-hover/btn:rotate-12 transition-transform duration-300" />
              Read Docs
            </NuxtLink>
          </div>
        </div>
        ...
        <div class="group relative bg-white/50 dark:bg-gray-900/30 backdrop-blur-sm border border-gray-200 dark:border-gray-700/50 rounded-2xl p-6 md:p-8 text-center hover:border-gray-300 dark:hover:border-gray-600/50 transition-all duration-300 flex flex-col h-full">
          <div class="relative z-10 flex flex-col h-full">
            ...
            <a
              ...
              class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-xl text-sm font-medium text-blue-600 dark:text-blue-300 hover:bg-blue-500/30 hover:border-blue-500/50 transition-all duration-300 group/btn"
            >
              <ChatBubbleLeftRightIcon class="mr-2 h-4 w-4 group-hover/btn:rotate-12 transition-transform duration-300" />
              Join Discussion
            </a>
          </div>
        </div>
        ...
        <div class="group relative bg-white/50 dark:bg-gray-900/30 backdrop-blur-sm border border-gray-200 dark:border-gray-700/50 rounded-2xl p-6 md:p-8 text-center hover:border-gray-300 dark:hover:border-gray-600/50 transition-all duration-300 flex flex-col h-full">
          <div class="relative z-10 flex flex-col h-full">
            ...
            <a
              ...
              class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-xl text-sm font-medium text-blue-600 dark:text-blue-300 hover:bg-blue-500/30 hover:border-blue-500/50 transition-all duration-300 group/btn"
            >
              <ArrowTopRightOnSquareIcon class="mr-2 h-4 w-4 group-hover/btn:rotate-12 transition-transform duration-300" />
              Visit Website
            </a>
          </div>
        </div>
      ...
      <!-- Stats Section -->
      <div class="mt-24 pt-16 border-t border-gray-200 dark:border-gray-700/30">
