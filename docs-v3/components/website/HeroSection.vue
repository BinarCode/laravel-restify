          ...
          <div class="hero-terminal">
            ...
            <div class="hero-terminal-header">
              ...
              <div class="hero-terminal-command">
                ...
                <button @click="copyToClipboard" class="hero-copy-button group" title="Copy command">
                  <ClipboardIcon v-if="!copied" class="hero-icon-sm group-hover:text-white" />
                  <CheckIcon v-else class="hero-icon-sm text-blue-400" />
                </button>
              </div>
            </div>
