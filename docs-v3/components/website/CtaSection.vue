<template>
  <section class="py-24 bg-gradient-to-b from-gray-900 to-slate-950 relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <!-- Quick Links -->
            <!-- Quick Links -->
      <div class="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center px-4 md:px-0">
        <NuxtLink
          to="/docs"
          class="group inline-flex items-center px-6 md:px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-semibold rounded-2xl transition-all duration-300 shadow-xl shadow-blue-500/25 hover:shadow-blue-500/40 hover:scale-105 w-full sm:w-auto justify-center min-h-[56px]">
        ...
        <a
          ...
          class="group inline-flex items-center px-6 md:px-8 py-4 bg-gradient-to-r from-gray-800/80 to-gray-700/80 backdrop-blur border border-gray-600/50 hover:border-gray-500/70 text-white font-semibold rounded-2xl transition-all duration-300 hover:scale-105 w-full sm:w-auto justify-center min-h-[56px]">
