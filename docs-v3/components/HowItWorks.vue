<template>
  <section class="py-20" :id="id">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center justify-center">
      <!-- Laravel Models -->
      <div class="text-center">
        <div class="w-24 h-24 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center mb-8 mx-auto shadow-xl">
          <Database :size="48" class="text-white" />
        </div>
      ...
      <!-- Restify Processing -->
      <div class="text-center">
        <div class="w-24 h-24 bg-gradient-to-br from-slate-500 to-slate-600 rounded-2xl flex items-center justify-center mb-8 mx-auto shadow-xl">
      ...
      <!-- Dual Output -->
      <div class="space-y-8">
        <div class="p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-xl flex items-center">
        ...
        <div class="p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-xl flex items-center">
          <div class="w-12 h-12 bg-gradient-to-br from-slate-500 to-slate-600 rounded-xl flex items-center justify-center mr-4">
