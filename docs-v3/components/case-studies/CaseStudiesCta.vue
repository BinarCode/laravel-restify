<template>
  <div class="relative bg-white/80 dark:bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-gray-200 dark:border-gray-700/50 p-8 md:p-12 overflow-hidden">
