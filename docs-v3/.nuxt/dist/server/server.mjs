import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, ref, computed, defineComponent, createElementBlock, provide, cloneVNode, h, Suspense, Fragment, useSSRContext, unref, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/eduardlupacescu/Sites/binarcode/laravel-restify/docs-v3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/eduardlupacescu/Sites/binarcode/laravel-restify/docs-v3/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie } from "/Users/eduardlupacescu/Sites/binarcode/laravel-restify/docs-v3/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "/Users/eduardlupacescu/Sites/binarcode/laravel-restify/docs-v3/node_modules/radix3/dist/index.mjs";
import { defu } from "/Users/eduardlupacescu/Sites/binarcode/laravel-restify/docs-v3/node_modules/defu/dist/defu.mjs";
import { withQuery, hasProtocol, isScriptProtocol, joinURL, withoutTrailingSlash, withBase, withLeadingSlash } from "/Users/eduardlupacescu/Sites/binarcode/laravel-restify/docs-v3/node_modules/ufo/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/Users/eduardlupacescu/Sites/binarcode/laravel-restify/docs-v3/node_modules/nuxt/node_modules/@unhead/vue/dist/index.mjs";
import { hash } from "/Users/eduardlupacescu/Sites/binarcode/laravel-restify/docs-v3/node_modules/ohash/dist/index.mjs";
import { klona } from "/Users/eduardlupacescu/Sites/binarcode/laravel-restify/docs-v3/node_modules/klona/dist/index.mjs";
import { parse } from "/Users/eduardlupacescu/Sites/binarcode/laravel-restify/docs-v3/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "/Users/eduardlupacescu/Sites/binarcode/laravel-restify/docs-v3/node_modules/destr/dist/index.mjs";
import { isEqual } from "/Users/eduardlupacescu/Sites/binarcode/laravel-restify/docs-v3/node_modules/nuxt/node_modules/ohash/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-eMvl-OO3.js")
  },
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import("./_nuxt/_...slug_-DftSeLot.js")
  }
];
...
const LazyAlert = defineAsyncComponent(() => import("./_nuxt/Alert-Bzv0dX9C.js").then((r) => r["default"] || r.default || r));
const LazyList = defineAsyncComponent(() => import("./_nuxt/List-bpLfPrH_.js").then((r) => r["default"] || r.default || r));
const LazyProseAlert = defineAsyncComponent(() => import("./_nuxt/ProseAlert-CEzsUDqh.js").then((r) => r["default"] || r.default || r));
const LazyProseList = defineAsyncComponent(() => import("./_nuxt/ProseList-DbZlgnKO.js").then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import("./_nuxt/ProsePre-DSy9m4do.js").then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import("./_nuxt/ContentDoc-JTwMwfjD.js").then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import("./_nuxt/ContentList-DJ9pkZ54.js").then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import("./_nuxt/ContentNavigation-Bdzqkgc0.js").then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import("./_nuxt/ContentQuery-Dx39Jk9x.js").then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import("./_nuxt/ContentRenderer-zmukH47a.js").then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import("./_nuxt/ContentRendererMarkdown-CluCOcfv.js").then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/ProseA-DwA_bgdq.js").then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/ProseH1-5cSxPJIg.js").then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/ProseH2-DKP0_ehy.js").then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/ProseH3-Bcp-2hcy.js").then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/ProseH4-Bs8AvShh.js").then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-git73fNg.js").then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-BYQrzHw2.js").then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/ProseHr-Bidow6pB.js").then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/ProseImg-DWrPiW1e.js").then((r) => r["default"] || r.default || r));
...
const lazyGlobalComponents = [
  ["Alert", LazyAlert],
  ["List", LazyList],
  ["ProseAlert", LazyProseAlert],
  ["ProseList", LazyProseList],
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./_nuxt/client-db-CMqR1HZz.js").then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./_nuxt/client-db-CMqR1HZz.js").then((m) => m.generateNavigation);
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-CqrEyZWG.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CIMf3jUa.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BjHgOXCM.js"));
