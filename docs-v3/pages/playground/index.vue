...
const placeholderText = computed(function computePlaceholderText() {
...
function loadExample(exampleEndpoint: string, exampleMethod: string): void {
...
function loadMcpExample(exampleEndpoint: string, exampleMethod: string, exampleBody: string): void {
