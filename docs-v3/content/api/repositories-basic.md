...
For detailed MCP configuration, see the [MCP Repositories](/mcp/repositories) documentation.

## What's Next?

You now know the basics of Laravel Restify repositories! For more advanced features, check out:

- **[Advanced Repositories](/api/repositories-advanced)** - Query customization, lifecycle events, custom routes
- **[Fields](/api/fields)** - Advanced field types and customization  
- **[Authorization](/auth/authorization)** - Advanced security and permissions
- **[MCP Integration](/mcp/repositories)** - Full AI agent integration
