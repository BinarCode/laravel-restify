---
title: Quick Start
description: Get started with Laravel Restify in minutes. Install via Composer, run the setup command, and serve a full REST API from your Laravel application.
...
**Need Authentication?** Check our [Authentication Guide](/docs/auth/authentication) for detailed setup instructions including login endpoints and token management.
...
**Learn More:** Check the [MCP Server Guide](/docs/mcp/mcp) for advanced configuration and usage with AI tools like Claude Desktop.
...
- **[Authentication](/docs/auth/authentication)** - Secure your API with Sanctum
- **[Repositories](/docs/api/repositories)** - Learn about fields, validation, and relationships  
- **[Search & Filtering](/docs/search/basic-filters)** - Add powerful query capabilities
- **[Authorization](/docs/auth/authorization)** - Control access with Laravel policies
- **[MCP Server](/docs/mcp/mcp)** - Enable AI agents to interact with your API
