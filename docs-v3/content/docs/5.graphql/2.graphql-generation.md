...
description: Learn how Laravel Restify auto-generates GraphQL schemas, queries, mutations, and resolver classes from your repositories using a single Artisan command.
category: GraphQL
---
