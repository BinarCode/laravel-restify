...
description: "Laravel Restify auto-generates GraphQL schemas and resolvers from your repositories, enabling full CRUD operations via GraphQL using Lighthouse."
category: GraphQL
---
...
1. **[Schema Generation](/docs/graphql/graphql-generation)** - Learn about the schema generation command and its options
