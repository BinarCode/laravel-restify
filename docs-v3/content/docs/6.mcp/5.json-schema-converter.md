...
description: Learn how Restify converts Laravel validation rules into JSON Schema for MCP agents using JsonSchemaFromRulesAction, with wildcard array and type support.
category: MCP
---
