---
title: MCP Getters
description: "Learn how to expose Laravel Restify Getters to AI agents via MCP, with validation rules, JSON Schema generation, hideFromMcp(), and security best practices."
category: MCP
---
