---
title: MCP Actions
description: Learn how to expose Laravel Restify actions to AI agents via MCP, configure action scopes, generate JSON Schema from validation rules, and control visibility.
category: MCP
---
