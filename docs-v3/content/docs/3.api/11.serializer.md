---
title: Serializer
description: "Learn how Laravel Restify's Serializer and rest() helper return consistent JSON:API-style responses with fluent methods for relations and sorting."
category: API
---
