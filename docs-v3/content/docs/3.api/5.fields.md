---
title: Fields
description: "Learn how to declare and customize model attribute fields in Laravel Restify using a fluent API with built-in validation, mutators, and computed values."
category: API
---
...
Actionable fields handle [store](/docs/api/repositories#store-request), put, [bulk store](/docs/api/repositories#store-bulk-flow) and bulk update requests.
