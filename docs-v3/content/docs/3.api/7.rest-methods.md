---
title: REST Methods
description: "Learn how Laravel Restify's RestController and RestResponse structure help you return consistent, JSON:API-compatible responses across all your API endpoints."
category: API
---
