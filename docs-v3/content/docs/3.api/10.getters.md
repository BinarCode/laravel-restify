---
title: Getters
description: "Learn how to define and register Getters in Laravel Restify — repository-attached GET endpoints with authorization, show/index scopes, and MCP integration."
category: API
---
