...
description: "Generate Laravel Restify repositories with smart path detection and automatic relationship scaffolding using the restify:repository Artisan command."
category: API
---
