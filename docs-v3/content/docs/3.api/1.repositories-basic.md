...
description: Learn how Laravel Restify repositories expose Eloquent models as REST APIs with automatic CRUD endpoints, field definitions, and full control over validation.
category: API
---
