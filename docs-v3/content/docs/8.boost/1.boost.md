---
title: Boost Package
description: Restify Boost is a Laravel Restify extension that adds an MCP server, letting AI agents generate repositories, actions, getters, and query API docs.
category: Extensions
---
