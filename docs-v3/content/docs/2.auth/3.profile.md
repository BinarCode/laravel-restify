...
description: "Learn how Restify's profile endpoint lets authenticated users retrieve and update their data using UserRepository for full control over exposed fields."
category: Auth
---
...
Make sure you followed the [Authentication](/docs/auth/authentication) guide first, as you need the authentication middleware configured:
...
If you need to customize the path or disk for the storage file, check the [image field](/docs/api/fields#file-fields) documentation.
