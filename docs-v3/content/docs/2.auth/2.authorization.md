---
title: Authorization
description: Laravel Restify unifies authorization across REST API endpoints and MCP tools using Laravel policies, covering gates, lifecycle, and access control.
category: Auth
---
...
You may also visit the [Authentication/login](/docs/auth/authentication#authorization) section to learn how to login and use the Bearer token.
