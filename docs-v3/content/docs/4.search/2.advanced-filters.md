...
description: Build custom Advanced Filters in Laravel Restify by extending AdvancedFilter — define rules, authorize access, and filter Eloquent queries your way.
category: Search & Filtering
---

Restify has [base filters](/docs/search/basic-filters) for usual `search` or `matching`. 
