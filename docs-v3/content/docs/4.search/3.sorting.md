---
title: Sorting
description: "Learn how to sort API results in Laravel Restify using the $sort property, query parameters, and relation-based sorting for hasOne relationships."
